...
/*** RCC */
#define	D2CCIP2R_LPTIM1SEL_PCLK1	(0 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))
#define	D2CCIP2R_LPTIM1SEL_PLL2Q	(1 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))
#define	D2CCIP2R_LPTIM1SEL_PLL3R	(2 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))
#define	D2CCIP2R_LPTIM1SEL_LSE		(3 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))
#define	D2CCIP2R_LPTIM1SEL_LSI		(4 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))
#define	D2CCIP2R_LPTIM1SEL_PER		(5 << (RCC_D2CCIP2R_LPTIM1SEL_Pos))

#define	D2CCIP2R_CECSEL_LSE		(0 << (RCC_D2CCIP2R_CECSEL_Pos))
#define	D2CCIP2R_CECSEL_LSI		(1 << (RCC_D2CCIP2R_CECSEL_Pos))
#define	D2CCIP2R_CECSEL_CSI		(2 << (RCC_D2CCIP2R_CECSEL_Pos))
#define	D2CCIP2R_CECSEL_RESERVED3	(3 << (RCC_D2CCIP2R_CECSEL_Pos))

#define	D2CCIP2R_USBSEL_DISABLE		(0 << (RCC_D2CCIP2R_USBSEL_Pos))
#define	D2CCIP2R_USBSEL_PLL1Q		(1 << (RCC_D2CCIP2R_USBSEL_Pos))
#define	D2CCIP2R_USBSEL_PLL3Q		(2 << (RCC_D2CCIP2R_USBSEL_Pos))
#define	D2CCIP2R_USBSEL_HSI48		(3 << (RCC_D2CCIP2R_USBSEL_Pos))

#define	D2CCIP2R_I2C123SEL_PCLK1	(0 << (RCC_D2CCIP2R_I2C123SEL_Pos))
#define	D2CCIP2R_I2C123SEL_PLL3R	(1 << (RCC_D2CCIP2R_I2C123SEL_Pos))
#define	D2CCIP2R_I2C123SEL_HSI		(2 << (RCC_D2CCIP2R_I2C123SEL_Pos))
#define	D2CCIP2R_I2C123SEL_CSI		(3 << (RCC_D2CCIP2R_I2C123SEL_Pos))

#define	D2CCIP2R_RNGSEL_HSI8		(0 << (RCC_D2CCIP2R_RNGSEL_Pos))
#define	D2CCIP2R_RNGSEL_PLL1Q		(1 << (RCC_D2CCIP2R_RNGSEL_Pos))
#define	D2CCIP2R_RNGSEL_LSE		(2 << (RCC_D2CCIP2R_RNGSEL_Pos))
#define	D2CCIP2R_RNGSEL_LSI		(3 << (RCC_D2CCIP2R_RNGSEL_Pos))

#define	D2CCIP2R_USART16SEL_PCLK2	(0 << (RCC_D2CCIP2R_USART16SEL_Pos))
#define	D2CCIP2R_USART16SEL_PLL2Q	(1 << (RCC_D2CCIP2R_USART16SEL_Pos))
#define	D2CCIP2R_USART16SEL_PLL3Q	(2 << (RCC_D2CCIP2R_USART16SEL_Pos))
#define	D2CCIP2R_USART16SEL_HSI		(3 << (RCC_D2CCIP2R_USART16SEL_Pos))
#define	D2CCIP2R_USART16SEL_CSI		(4 << (RCC_D2CCIP2R_USART16SEL_Pos))
#define	D2CCIP2R_USART16SEL_LSE		(5 << (RCC_D2CCIP2R_USART16SEL_Pos))

#define	D2CCIP2R_USART28SEL_PCLK2	(0 << (RCC_D2CCIP2R_USART28SEL_Pos))
#define	D2CCIP2R_USART28SEL_PLL2Q	(1 << (RCC_D2CCIP2R_USART28SEL_Pos))
#define	D2CCIP2R_USART28SEL_PLL3Q	(2 << (RCC_D2CCIP2R_USART28SEL_Pos))
#define	D2CCIP2R_USART28SEL_HSI		(3 << (RCC_D2CCIP2R_USART28SEL_Pos))
#define	D2CCIP2R_USART28SEL_CSI		(4 << (RCC_D2CCIP2R_USART28SEL_Pos))
#define	D2CCIP2R_USART28SEL_LSE		(5 << (RCC_D2CCIP2R_USART28SEL_Pos))
...
#define	SR_PGSERR_SHIFT		(FLASH_CR_PGSERRIE_Pos)
...
#define	CR_SNB_SHIFT		(FLASH_CR_SNB_Pos)
#define	CR_SNB_MASK		(0x7 << (CR_SNB_SHIFT))
#define	CR_SNB_SECT(x)		((x) << (CR_SNB_SHIFT))
#define	CR_START_SHIFT		(FLASH_CR_START_Pos)
#define	CR_START_MASK		(1 << (CR_STRT_SHIFT))
#define	CR_START_NO		(0 << (CR_STRT_SHIFT))
#define	CR_START_YES		(1 << (CR_STRT_SHIFT))
#define	CR_BER_SHIFT		(FLASH_CR_BER_Pos)
#define	CR_BER_MASK		(1 << (CR_BER_SHIFT))
#define	CR_BER_NO		(0 << (CR_BER_SHIFT))
#define	CR_BER_YES		(1 << (CR_BER_SHIFT))
#define	CR_SER_SHIFT		(FLASH_CR_SER_Pos)
#define	CR_SER_MASK		(1 << (CR_SER_SHIFT))
#define	CR_SER_NO		(0 << (CR_SER_SHIFT))
#define	CR_SER_YES		(1 << (CR_SER_SHIFT))
#define	CR_PG_SHIFT		(FLASH_CR_PG_Pos)
#define	CR_PG_MASK		(1 << (CR_PG_SHIFT))
#define	CR_PG_NO		(0 << (CR_PG_SHIFT))
#define	CR_PG_YES		(1 << (CR_PG_SHIFT))
#define	CR_LOCK_SHIFT		(FLASH_CR_LOCK_Pos)
...
#define	GPIO_PTR	((struct _stStm32_GPIO *) (GPIOA_BASE))
#define	RCC_PTR		((struct _stStm32_RCC *) (RCC_BASE))
